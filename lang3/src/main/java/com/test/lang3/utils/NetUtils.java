...
public abstract class NetUtils {
    ...
    public static final Boolean KUBERNETES_MODE = StringUtils.hasText(System.getenv("KUBERNETES_SERVICE_HOST")) && StringUtils.hasText(System.getenv("KUBERNETES_SERVICE_PORT"));
    ...
    private static boolean isSpecifyNetworkInterface(NetworkInterface networkInterface) {
        ...
        String preferredNetworkInterface = null;
    ...
    public static void main(String[] args) {
        System.out.println(NetUtils.getHost());
    }
